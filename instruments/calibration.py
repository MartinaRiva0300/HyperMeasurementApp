...
are resolved relative to this package (``Twins/calibration``) first,
...
# This file is instruments/calibration.py -> package root is the app root.
_PKG_ROOT = Path(__file__).resolve().parent.parent
_CAL_DIR = Path("Twins") / "calibration"
...
_SPECTRAL_PATHS = [
    ...
    _PKG_ROOT / _CAL_DIR / "parameters_cal.txt",        # Twins/calibration/...
