...
Hardware here is a SmarAct **MCS2** controller driving an **SLC-1750** closed-loop
linear piezo positioner (with position sensor), via SmarAct's MCS2 SDK
...
Usage:
    ...
    st.move_to(10.0); st.wait_for_stop()
...
# >>> TUNE THESE TO YOUR RIG <<<
# SLC-1750 nominal travel. Verify against the label on YOUR positioner before
# trusting absolute moves -- the UI spin-box range is derived from this.
TRAVEL_MM = 50.0                 # SLC-1750 closed-loop travel range (mm)
...
class TwinsStage:
    """SmarAct MCS2 closed-loop SLC-1750 linear stage (the TWINS wedge translator)."""
