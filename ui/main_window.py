...
class MainWindow(QMainWindow):
    def __init__(
        ...
        self.setWindowTitle("SWIR Hyperspectral Acquisition")
    ...
    def _build_camera_group(self) -> QGroupBox:
        ...
        # -- Forge SWIR GenICam options (applied through Spinnaker) -----------
        layout.addWidget(QLabel("— Forge SWIR options —"))
        self.opt_combos = {}
